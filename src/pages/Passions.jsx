...
function Passions() {
    return (<div style={ { justifyItems: "center" } }>
        ...
        <MyRightPassion
            title="Voyage"
            description="Tout au long de mon enfance j'ai eu la chance de visiter plusieurs pays à travers le monde, ce qui m'a permis de voir différentes cultures mais aussi de développer ma passion pour les voyages.
        ...
        <MyRightPassion
            ...
            description="J'ai découvert la programmation en avril 2021 lors d'un stage découverte et j'ai tout de suite énormément apprécié ce métier, c'est qui m'a, entre autre, donné envie de faire cet apprentissage. Malgré quelque difficulté quant à la logique de certains languages, je reste toujours à l'affût des nouveauté et vais constemment chercher à apprendre de nouvelles choses"
